...
- `fill_height` lets the card cooperate with Home Assistant's grid sizing so it can occupy extra allocated height more predictably while keeping the default auto-sized behavior when disabled.
